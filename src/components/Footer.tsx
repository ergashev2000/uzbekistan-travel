        ...
        <div className="container mx-auto flex gap-5">
          <div className="space-y-5 w-2/5">
            ...
            <div className="flex gap-5 pb-5">
              <div>
                <Link href={"tel+998909686858"}>
                  <span className="text-sm font-semibold underline-animation hover:text-[#ea6070] transition-all duration-300">
                    +998(90) 968 68 58
                  </span>
                </Link>
            ...
            <p className="text-sm">
              ...
              <Link href={"/"}>
                <span className="font-semibold text-[#ea6070]">1173</span>
              </Link>
            </p>
            ...
            {footerMenus.map((menus, i) => (
              ...
              >
                {menus.map(menu => (
                  <li
                    key={menu.id}
                    className="first:text-lg first:text-white first:font-semibold underline-animation"
                  >
                    <Link href={menu.slug}>
                      <h3 className="hover:text-[#FA7436] transition-all duration-300">
                        {menu.menu}
                      </h3>
                    </Link>
                  </li>
