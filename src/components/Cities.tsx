  ...
  return (
    <section ref={ref}>
      <Link href={"/cities"} className="w-fit block">
        <h2 className="text-lg xl:text-3xl 2xl:text-4xl font-semibold w-fit my-4 xl:my-10 flex items-center gap-2 [&>div]:hover:ml-2 [&>div]:hover:opacity-100 transition-all duration-300 text-[#FA7436]">
          {t("cities")}
